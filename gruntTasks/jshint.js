...
module.exports = function(grunt){
	...
	//options
	return {
		files: ['app.js','server.js','public/gruntTasks/**/*.js','public/js/app.js','public/js/ngControllers/**/*.js', 'app/**/*.js', 'tests/**/*.js'],		
		...
		options : {
			...
			//Miscalleneous option. Options  that will either be deprecated/developer's judgement
			//Blanket
			//enforceall : false,
			// maxerr : 50,
			// varstmt : false,
			...
			// Version 
			// es5 : true,				//true by default			
			// indent : false,
			// noarg : false,

			//Code Complexity and efficiency
			// maxcomplexity : 5,	//Cyclomatic complexity, TBD
			// maxstatements : 20,
